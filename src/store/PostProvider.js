  ...
  items: [
    {
      ...
      comments: ["This", "Does", "Work"],
      likes: 8,
      date: "4:38 PM · Oct 11, 2021",
    },
    {
      poster_id: 2,
      id: 2,
      message: "Happy birthday Snoop",
      comments: [
...
const PostProvider = (props) => {
  const [newPost, dispatchNewPost] = useReducer(
    postReducer,
    defaultPosts
    /*Just a little reminder to have a great day*/
  );

  const addPostHandler = (items) => {
